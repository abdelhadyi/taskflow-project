  ...
  return (
    <div style={page}>
      <div style={card}>
        ...
        <h1 style={{ fontSize: '1.4rem', fontWeight: 700, marginBottom: '.35rem' }}>Create account</h1>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div className="form-group">
            ...
            <input className="input" placeholder="Alice Smith"
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '.875rem', color: 'var(--text-2)' }}>
          ...
          <Link to="/login" style={{ color: 'var(--accent-h)', fontWeight: 600 }}>Sign in</Link>
        </p>
      </div>
    </div>
  )
